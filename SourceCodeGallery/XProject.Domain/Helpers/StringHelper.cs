...
namespace XProject.Domain.Helpers
{
    public static class StringHelper
    {
        ...
        public static string GenerateSlugById(int id, string name)
        {
            string phrase = string.Format("{0}-{1}", id, name);

            string str = StringHelper.RemoveAccent(phrase).ToLower();
            // invalid chars           
        ...
        public static string GenerateSlugCode(this string name)
        {
