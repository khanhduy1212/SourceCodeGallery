...
(function (root, factory) {
    ...
    smoothScroll.animateScroll = function ( toggle, anchor, options ) {
        ...
        var settings = extend( settings || defaults, options || {}, overrides ); // Merge UserLogin options with defaults
     ...
     * @public
     * @param {Object} options UserLogin settings
     */
    smoothScroll.init = function ( options ) {
        ...
        // Selectors and variables
        settings = extend( defaults, options || {} ); // Merge UserLogin options with defaults
