...
namespace XProject.Web.Infrastructure.Helpers
{
    ...
    {
        public static Stream FromImageUrlToStream(string imgUrl)
        {
        ...
        public static Drawing DrawingManager(string relationshipId, string name, Int64Value cxVal, Int64Value cyVal, string impPosition)
        {
            ...
            anchor.DistanceFromLeft = (UInt32Value)0U;
