...
(function ($, window) {
        ...
        configureStopReconnectingTimeout = function (connection) {
            ...
            if (!connection._.configuredStopReconnectingTimeout) {
                ...
                connection.reconnecting(function () {
                    ...
                    // Guard against state changing in a previous UserLogin defined even handler
    ...
    signalR._ = {
        ...
        ieVersion: (function () {
            ...
            if (window.navigator.appName === 'Microsoft Internet Explorer') {
                // Check if the UserLogin agent has the pattern "MSIE (one or more numbers).(one or more numbers)";
    ...
    function validateTransport(requestedTransport, connection) {
        ...
        /// <param name="requestedTransport" type="Object">The designated transports that the UserLogin has specified.</param>
    ...
    signalR.fn = signalR.prototype = {
        ...
        keepAliveWarnAt: 2 / 3, // Warn UserLogin of slow connection if we breach the X% mark of the keep alive timeout
    ...
    function checkIfAlive(connection) {
        ...
        if (connection.state === signalR.connectionState.connected) {
            ...
            if (timeElapsed >= keepAliveData.timeout) {
                ...
                // This is to assure that the UserLogin only gets a single warning
