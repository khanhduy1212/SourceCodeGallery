...
Highcharts.VMLElement = VMLElement = {
	...
	setSpanRotation: function () {
		...
		// but it can probably be implemented for Firefox 3.5+ on UserLogin request. FF3.5+
...
AxisPlotLineOrBandExtension = {
	...
	addPlotBandOrLine: function (options, coll) {
		...
		if (obj) { // #2189
			// Add it to the UserLogin options for exporting and Axis.update
			if (coll) {
...
Axis.prototype = {
	...
	/**
	 * Set the scale based on data min and max, UserLogin set min and max or options
	 *
	 */
	setScale: function () {
		var axis = this,
	...
	getOffset: function () {
		...
		// handle automatic or UserLogin set offset
...
Tooltip.prototype = {
	...
	/**
	 * In case no UserLogin defined formatter is given, this will be used. Note that the context
...
extend(Highcharts.Pointer.prototype, {
	...
	pinchTranslateDirection: function (horiz, pinchDown, touches, transform, selectionMarker, clip, lastValidTouch, forcedScale) {
		...
		if (outOfBounds) {
			...
			// to the UserLogin that the chart is responsive but can't be dragged further.
...
Series.prototype = {
	...
	render: function () {
		...
		// which should be available to the UserLogin).
		if (!hasRendered) {
			if (animDuration) {
...
function StackItem(axis, options, isNegative, x, stackOption) {
	...
	// First test the UserLogin supplied value, then use the dynamic.
	this.alignOptions = {
...
extend(Series.prototype, {
	...
	update: function (newOptions, redraw) {
		var chart = this.chart,
			// must use UserLogin options when changing type because this.options is merged
