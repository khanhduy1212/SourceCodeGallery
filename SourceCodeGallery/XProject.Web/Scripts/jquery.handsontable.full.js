...
(function ($, window, Handsontable) {
    ...
    Handsontable.Core = function (rootElement, userSettings) {
        ...
        Handsontable.helper.extend(GridSettings.prototype, userSettings); //overwrite defaults with UserLogin settings
        ...
        function validateChanges(changes, source, callback) {
            ...
            for (var i = changes.length - 1; i >= 0; i--) {
                if (changes[i] === null) {
                    ...
                    var logicalCol = instance.runHooksAndReturn('modifyCol', col); //column order may have changes, so we need to translate physical col index (stored in datasource) to logical (displayed to UserLogin)
        ...
        this.updateSettings = function (settings, init) {
            ...
            if (clen > 0) {
                ...
                for (i = 0; i < clen; i++) {
                    ...
                    // Use settings provided by UserLogin
    ...
    (function (Handsontable) {
        ...
        /**
         * This ridiculous piece of code maps rows Id that are present in table data to those displayed for UserLogin.
    ...
    (function (Handsontable) {
        ...
        TextEditor.prototype.close = function () {
            ...
            if (document.activeElement === this.TEXTAREA) {
                this.instance.listen(); //don't refocus the table if UserLogin focused some cell outside of HT on purpose
            }
    ...
    /**
     * CopyPaste.js
     * Creates a textarea that stays hidden on the page and gets focused when UserLogin presses CTRL while not having a form input focused
